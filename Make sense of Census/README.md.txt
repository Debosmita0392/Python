...
print(nType of data nn, type(data))
Output
...
Create a new subset array called 'senior_citizens' by filtering 'census' according to age60 (age is the column with index 0)
...
Create two new subset arrays called 'high' and 'low' by filtering 'census' according to education-num10 and education-num=10 (education-num is the column with index 1) respectively.
